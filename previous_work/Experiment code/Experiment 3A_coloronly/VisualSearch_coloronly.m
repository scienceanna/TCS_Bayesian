...
%
%   This experiment uses a red target (that faces left or right; the 
...
%%%%%%%%%%%%%%%%%% INITIALIZATION %%%%%%%%%%%%%%%%%%%%%%%%%%
   ...
   KbName('UnifyKeyNames');
    ...
    % Output file
    fid=fopen(['VisualSearch_TriTar_coloronly_' num2str(SbjID) '.out'],'a');  
...
bright=imread('bRtri.png'); %blue right triangle
bleft=imread('bLtri.png'); %blue left triangle

%bl=Screen('MakeTexture',window,b);
%ye=Screen('MakeTexture',window,y);
yright=imread('yRtri.png'); %yellow triangle
yleft=imread('yLtri.png');%yellow left triangle

oright=imread('oRtri.png');%orange right triangle
oleft=imread('oLtri.png');%orange left triangle
