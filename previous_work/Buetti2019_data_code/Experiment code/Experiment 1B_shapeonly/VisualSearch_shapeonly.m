...
%
%   This experiment uses gray scale objects.  The target is a semi-circle 
...
%%%%%%%%%%%%%%%%%% INITIALIZATION %%%%%%%%%%%%%%%%%%%%%%%%%%
   ...
   KbName('UnifyKeyNames');
    ...
    % Output file
    fid=fopen(['VisualSearch_shapeonly' num2str(SbjID) '.out'],'a');  
...
b=imread('graycircle.jpg'); %blue circle
%bl=Screen('MakeTexture',window,b);
yr=imread('grayRtri.jpg'); %right yellow triangle
%ye=Screen('MakeTexture',window,y);
yl=imread('grayLtri.jpg');%left yellow triangle
o=imread('graydiamond.jpg');%orange diamond
...
rr=imread('rlgraycircle.jpg');
rrt=Screen('MakeTexture',window,rr);
%tid=0
rl=imread('llgraycircle.jpg');
rlt=Screen('MakeTexture',window,rl);
%tid=1
