...
%%%%%%%%%%%%%%%%%% INITIALIZATION %%%%%%%%%%%%%%%%%%%%%%%%%%
   ...
   KbName('UnifyKeyNames');
    ...
    % Output file
    fid=fopen(['VisualSearch_TriTar_colorandshape_Comb1_' num2str(SbjID) '.out'],'a');  
...
b=imread('bcircle.png'); %blue circle
%bl=Screen('MakeTexture',window,b);
yr=imread('yRsemicir.png'); %right yellow semi-circle
%ye=Screen('MakeTexture',window,y);
yl=imread('yLsemicir.png');%left yellow semi-circle
o=imread('odiamond.png');%orange diamond
