...
plt_nrl <- plot_model_fits_rt(1, prior_model_nrl)
plt_log <- plot_model_fits_rt(1, prior_model_log)
plt_sft <- plot_model_fits_rt(1, prior_model_sft)
