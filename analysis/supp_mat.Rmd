...
slopes3 <- extract_fixed_slopes_from_model(m_exp3_log)
...
slopes2 <- extract_fixed_slopes_from_model(m_exp2_nrl)
Dp_samples2 <- get_Dp_samples(2, d, slopes1, slopes2)

slopes4 <- extract_fixed_slopes_from_model(m_exp4_nrl)
Dp_samples4 <- get_Dp_samples(4, d, slopes3, slopes4)

rm(slopes1, slopes2)

bind_rows(Dp_samples2, Dp_samples4) %>% 
...
ggsave("../plots/recreate_normal_fig_4.pdf", width = 8, height = 2.5)
...
d %>% group_by(p_id, exp_id) %>% summarise(m_rt = median(rt)) %>% 
