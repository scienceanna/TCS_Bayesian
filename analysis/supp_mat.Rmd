...
plt_nrl <- plot_model_fits_rt(1, prior_model_nrl, y_limits = c(-2, 5))
plt_log <- plot_model_fits_rt(1, prior_model_log, y_limits = c(0, 5))
plt_sft <- plot_model_fits_rt(1, prior_model_sft, y_limits = c(0, 5))
...
plt_nrl <- plot_model_fits_rt(1, m_exp1_nrl)
plt_log <- plot_model_fits_rt(1, m_exp1_log)
plt_sft <- plot_model_fits_rt(1, m_exp1_sft)
...
plt_nrl <- plot_model_fits_rt(1, m_exp1_nrl, inc_re = NULL, y_limits = c(0, 4))
plt_log <- plot_model_fits_rt(1, m_exp1_log, inc_re = NULL, y_limits = c(0, 4))
plt_sft <- plot_model_fits_rt(1, m_exp1_sft, inc_re = NULL, y_limits = c(0, 4))
...
plot_model_fits_rt(2, m_prt, y_limits = c(0, 2.5), n_row = 3, inc_re = NA)
```
...
plot_model_fits_rt(2, m_prt, y_limits = c(0, 2.5), n_row = 3, inc_re = NULL)
```
