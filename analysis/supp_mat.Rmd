...
```{r plt-post, fig.height=8, fig.cap="Posterior predictions for reaction time and log(N+1)."}
...
```{r plt-post-re, fig.height=8, fig.cap="Posterior predictions for reaction time and log(N+1)."}
