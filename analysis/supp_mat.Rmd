...
if (refit_models)
{
  ...
  saveRDS(m_exp2_log, "exp_2_log.models")
   #tidy 
  rm(m_exp2_log, mdl_inputs_log)
   
  mdl_inputs_sft <- set_up_model("2", d, "shifted_lognormal")
  m_exp2_sft <- run_model(mdl_inputs_sft, ppc = "no")
  # sve
  saveRDS(m_exp2_sft, "exp_2_sft.models")
  #tidy
  rm(m_exp3_log, mdl_inputs_log)
  ...
  m_exp2_sft <- readRDS("exp_2_sft.models")
