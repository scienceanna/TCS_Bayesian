...
bs_lint <- bridge_sampler(m_prt_linear_transform2, silent = TRUE)
...
plot_model_fits_rt(c("2a", "2b", "2c"), m_prt_best_feature2, y_limits = c(0.2, 0.8), n_row = 3, plot_type = "fitted")

plot_model_fits_rt(c("2a", "2b", "2c"), m_prt_collinear2, y_limits = c(0.2, 0.8), n_row = 3, plot_type = "fitted")

plot_model_fits_rt(c("2a", "2b", "2c"), m_prt_orthog_contrast2, y_limits = c(0.2, 0.8), n_row = 3, plot_type = "fitted")

plot_model_fits_rt(c("2a", "2b", "2c"), m_prt_linear_transform2, y_limits = c(0.2, 0.8), n_row = 3, plot_type = "fitted")
```

```{r, fig.height = 6}


plot_model_fits_rt(c("4a", "4b", "4c"), m_prt_best_feature4, y_limits = c(0.2, 0.8), n_row = 3, plot_type = "fitted")

plot_model_fits_rt(c("4a", "4b", "4c"), m_prt_collinear4, y_limits = c(0.2, 0.8), n_row = 3, plot_type = "fitted")

plot_model_fits_rt(c("4a", "4b", "4c"), m_prt_orthog_contrast4, y_limits = c(0.2, 0.8), n_row = 3, plot_type = "fitted")

plot_model_fits_rt(c("4a", "4b", "4c"), m_prt_linear_transform4, y_limits = c(0.2, 0.8), n_row = 3, plot_type = "fitted")
