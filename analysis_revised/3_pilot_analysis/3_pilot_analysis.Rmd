...
Which method has the lowest prediction error (or whatever the original authors call it)?
...
Now posterior probabilties...


```{r}
m_col <- bridge_sampler(m_col)
m_bfe <- bridge_sampler(m_bfe)
m_orc <- bridge_sampler(m_orc)
