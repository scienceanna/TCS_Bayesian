...
```{r, cache=FALSE, message = FALSE, warning = FALSE, echo = FALSE, fig.height = 5, , fig.cap = "Predicted RTs for our data, using collinear contrast combination."} 
