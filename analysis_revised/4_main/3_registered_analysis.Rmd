...
colourPalette <- c("#648FFF", "#785EF0", "#DC267F","#FE6100", "#FFB000")
...
```{r hypothesis-4-plot, cache=FALSE, message = FALSE, warning = FALSE, echo = FALSE, fig.height = 5, , fig.cap = "Predicted RTs for our data, using collinear contrast combination."} 
...
```{r hypothesis-4-bridge-sample, echo = FALSE, message = FALSE, warning = FALSE} 
