...
\end{tabular}
\caption{A table to show the logarithmic slope parameters for the three different models (best feature, orthogonal contrast and collinear contrast) along with the $R^2$ values for the three approaches, and the model weights based on bridge sampling.}
