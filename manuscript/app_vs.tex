...
\begin{itemize}
\item Direct replication, online? (Maybe with different colours/shapes?)
\item Extend number of distractors
\item Different classes of stimuli?
\item Within subject predictions? (This maybe can form part of the other points?)
\end{itemize}
