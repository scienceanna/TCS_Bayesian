...
We first describe the original analysis methods (and verify that we can replicate the original analysis - see Supplementary Materials) and then our modifications. 
