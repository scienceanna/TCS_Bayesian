...
Full details of a pilot experiment with $n=4$ participants (960 trials each) using our proposed analyses can be found in supplementary materials. This suggests that even with a small sample, we can convincingly demonstrate H1 and H2, however more data will be required to discriminate between the models in H3. 
