...
\\
\item \textbf{Increase number of distractors, and more peripheral distractors.} We therefore will an extra ring condition, with 43 distractors. This requires the addition of another ring of possible distractor positions compared to \cite{buetti2019predicting}, allowing the distractors in all conditions to be placed in more peripheral locations. This allows us to test one of the key principles of the TCS model: that reaction times should increase log-linearly with target number.
\end{enumerate}
