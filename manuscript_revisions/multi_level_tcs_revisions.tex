...
We first describe the original Target Contrast Model, as presented in \cite{buetti2019predicting} and verify that we can succesfully replicate the original analysis (both using frequentist modelling and Bayesian modelling; see Supplementary Materials).
...
Full details of a pilot experiment with $n=4$ participants (xxx trials) can be found in supplementary materials. This suggests that even with a small sample, we can convincing demostrate H1 and H2, however more data will be required to discriminate between the models in H3. 
...
Please see the analysis of our pilot data for a full implementation of our analysis pipeline, including all code...
