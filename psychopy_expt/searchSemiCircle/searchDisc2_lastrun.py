...
expName = 'searchDisc2'  # from the Builder filename that created this script
...
thisExp = data.ExperimentHandler(name=expName, version='',
    ...
    originPath='C:\\Users\\Marcin\\Desktop\\searchDiscWorking3\\searchDisc2_lastrun.py',
...
text_3 = visual.TextStim(win=win, name='text_3',
    text='Press 1 if you see left-facing semicircle\n\n\n\nPress 2 if you see right-facing semi circle\n\n\nPress SPACE to start',
    font='Arial',
...
image_3 = visual.ImageStim(
    ...
    ori=0, pos=(0.01, -0.3), size=(0.05, 0.1),
    color=[1,1,1], colorSpace='rgb', opacity=1,
    flipHoriz=False, flipVert=False,
...
for thisTrial_2 in trials_2:
    ...
    key_resp_7.rt = []
    _key_resp_7_allKeys = []
    if trials_2.thisTrialN == 0 or trials_2.thisTrialN % 19 != 0 or trials_2.thisTrialN > 19:
        continueRoutine = False
...
for thisTrial in trials:
    ...
    msg = "You have completed %i out of 480 trials. You got %i trials correct (rt=%.2f). Press space bar to continue." %(trials.thisTrialN+1,nCorr,meanRt)
